...
export async function POST(req: Request): Promise<Response> {
  try {
    ...
    {
      "productAnalysis": {
        "identifiedProduct": "Name of the product you see in the image",
        ...
        "brand": "Brand Name of the product",
          ...
          "estimatedCost": "Price of the product in Nepalese Rupees, find the closest price of the product online",
